...
def upgrade():
    ...
    op.execute(CreateSequence(Sequence('cijena_1_seq')))
    ...
    op.execute(CreateSequence(Sequence('cijena_1x_seq')))
    ...
    op.execute(CreateSequence(Sequence('cijena_2_seq')))
    ...
    op.execute(CreateSequence(Sequence('cijena_3_seq')))
    ...
    op.execute(CreateSequence(Sequence('cijena_4_seq')))
    ...
    op.execute(CreateSequence(Sequence('cijena_5_seq')))
    ...
    op.execute(CreateSequence(Sequence('departments_seq')))
    ...
    op.execute(CreateSequence(Sequence('koperanti_seq')))
    ...
    op.execute(CreateSequence(Sequence('roles_seq')))
    ...
    op.execute(CreateSequence(Sequence('employees_seq')))
    ...
    op.execute(CreateSequence(Sequence('zaprimka_seq')))
