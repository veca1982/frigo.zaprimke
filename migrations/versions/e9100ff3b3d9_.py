...
def upgrade():
    ...
    op.create_sequence('cijena_1_seq')
    ...
    op.create_sequence('cijena_1x_seq')
    ...
    op.create_sequence('cijena_2_seq')
    ...
    op.create_sequence('cijena_3_seq')
    ...
    op.create_sequence('cijena_4_seq')
    ...
    op.create_sequence('cijena_5_seq')
    ...
    op.create_sequence('departments_seq')
    ...
    op.create_sequence('koperanti_seq')
    ...
    op.create_sequence('employees_seq')
    ...
    op.create_sequence('zaprimka_seq')
