...
def delete_department(id):
    ...
    return render_template(title="Delete Department").encode( "utf-8" )
...
def list_roles():
    ...
    return render_template('admin/roles/roles.html',
                           roles=roles, title='Roles').encode( "utf-8" )
...
def add_role():
    ...
    return render_template('admin/roles/role.html', add_role=add_role,
                           form=form, title='Add Role').encode( "utf-8" )
...
def edit_role(id):
    ...
    return render_template('admin/roles/role.html', add_role=add_role,
                           form=form, title="Edit Role").encode( "utf-8" )
...
def delete_role(id):
    ...
    return render_template(title="Delete Role").encode( "utf-8" )
...
def list_employees():
    ...
    return render_template('admin/employees/employees.html',
                           employees=employees, title='Employees').encode( "utf-8" )
    ...
    if request.method == 'POST':
        ...
        if not message:
            ...
            try:
                # add nova cijena
                if last_cijena != None:
                    last_cijena.datum_do += cijena.datum_od.timedelta(days=-1)
