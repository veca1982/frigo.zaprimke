...
def __calculate_cijene(zaprimka):
    ...
    if not zaprimka.cijena_1_o:
        ...
        cijena_1 = Cijena1.query.filter(and_(Cijena1.datum_od >= zaprimka.datum_zaprimanja, or_(Cijena1.datum_do <= zaprimka.datum_zaprimanja, Cijena1.datum_do == None )))
    ...
    if not zaprimka.cijena_2_o:
        ...
        cijena_2 = Cijena2.query.filter(and_(Cijena2.datum_od >= zaprimka.datum_zaprimanja, or_(Cijena2.datum_do <= zaprimka.datum_zaprimanja, Cijena2.datum_do == None )))
    ...
    if not zaprimka.cijena_3_o:
        ...
        cijena_3 = Cijena3.query.filter(and_(Cijena3.datum_od >= zaprimka.datum_zaprimanja, or_(Cijena3.datum_do <= zaprimka.datum_zaprimanja, Cijena3.datum_do == None )))
    ...
    if not zaprimka.cijena_4_o:
        ...
        cijena_4 = Cijena4.query.filter(and_(Cijena4.datum_od >= zaprimka.datum_zaprimanja, or_(Cijena4.datum_do <= zaprimka.datum_zaprimanja, Cijena4.datum_do == None )))
    ...
    if not zaprimka.cijena_5_o:
        ...
        cijena_5 = Cijena5.query.filter(and_(Cijena5.datum_od >= zaprimka.datum_zaprimanja, or_(Cijena5.datum_do <= zaprimka.datum_zaprimanja, Cijena5.datum_do == None )))
